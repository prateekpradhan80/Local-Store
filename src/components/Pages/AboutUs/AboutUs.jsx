          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-4 text-3xl font-semibold text-primary text-red-600 ">
                  Why Choose LOCAL STORE
                </span>
                <h2 className="mb-5 text-xl font-semibold text-dark dark:text-white  ">
                  Make our customers happy by giving quality products in a
                  affordable price.
                </h2>
                <p className="mb-5 text-base text-body-color dark:text-dark-6">
                  ...
                  India-specific programs to support the thousands of small and
                  medium businesses in India that sell on Local Store.
                </p>
        ...
        <div className="w-1/3 bg-gray-200 m-4 rounded-2xl p-2 hover:bg-red-200">
          <div className="h-full text-center">
            ...
            <p className="leading-relaxed">
              ...
              websites, which is great. We had a quick delivery and good package
              as well
            </p>
        ...
        <div className=" w-1/3 bg-gray-200 m-4 rounded-2xl p-2 hover:bg-red-200">
          <div className="h-full text-center">
            <img
              alt="testimonial"
              className="w-32 h-32 mb-6 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100"
              src="https://yt3.ggpht.com/yti/ANjgQV8FzDWH0KOp7xls9gKUd7XdW_aSBifI2EF06yA2tA=s108-c-k-c0x00ffffff-no-rj"
            />
            <p className="leading-relaxed">
              T-shirts that are both affordable and comfortable are available. A
              wide range of styles, colours, and sizes are accessible. Shipping
              was quick, and the prices were reasonable. I've never had any
